 ...
 */
	public $migration = array(
		...
		'down' => array(
			'drop_table' => array(
				'o_auth_access_tokens', 'o_auth_auth_codes', 'o_auth_clients', 'o_auth_refresh_tokens'
			),
		),
	);
